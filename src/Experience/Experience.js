...
const Experience = () => (
  <div className="experience">
    <div className="heading txt-hover">Experience</div>
    <div className="wrapper">
      <div className="group">
        <div className="position txt-hover">Web design <span>HTML&CSS Developer</span></div>
        <div className="company txt-hover">Channel Wide Computer</div>
